...
class MainApplication:
    ...
    def __init__(self,root):
        ...
        #FaceIcon
        img=Image.open("UIimages/face-scan.png")
        ...
        #ItsoleraIcon
        img1=Image.open("UIimages/ki.jpg")
    ...
    def fetch_from_database(self):
        ...
        try:
            ...
            connecton=mc.connect(host="localhost",username="root",password="admin",database="school_attendance_system")
...
class Register:
    def __init__(self,root):
        ...
        self.bg=Image.open("UIimages/it2.jpg")
        ...
        self.bg2=Image.open("UIimages/register.jpg")
    ...
    def delete(self):
        ...
        if self.id.get()=="" or self.name.get()=='':
            ...
            try:
                ...
                image_path=f"F:\\Itsolera-Internship-main\\Attendance System using Face Recognition\\images\\{id}.jpg"
                path="F:\\Itsolera-Internship-main\\Student_Attendance_System_using_face_recognition\\JsonData\\member_ids.json"
                data_dic={}
...
class FinalReport:
    ...
    def __init__(self,root):
        ...
        self.db = mc.connect(
           ...
           database="school_attendance_system"
           )
        ...
        self.bg=Image.open("UIimages/report.jpg")
        ...
        if self.ID.get()=="":
            ...
            try:
               ...
               for record in self.student_attendance_data:
                   self.final_report.insert("end-1c",f"\n\nDate: {record[3]}, Time: {record[2]}, Marked: {record[4]}")
